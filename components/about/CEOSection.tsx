      ...
      <div className="container-custom">
        ...
        <Reveal delay={0.1}>
          <div className="max-w-4xl mx-auto">
            <div className="bg-ink-800 border border-white/10 rounded-2xl p-8 lg:p-12">
              <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <p className="text-xl bg-gradient-to-r from-primary-300 to-accent-300 bg-clip-text text-transparent font-semibold mb-6">
                    {ceo.position}
                  </p>
                  ...
                  {/* Experience */}
                  <div>
                    <h4 className="text-lg font-bold text-white mb-3">경력</h4>
